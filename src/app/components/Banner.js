...
return(
    ...
    <ScrollAnimation  animateIn='fadeIn'>
        <div id={id} className="container mx-auto max-w-mobile md:max-w-pc flex flex-wrap flex-col-reverse md:flex-row justify-between items-center md:py-32 py-20">
